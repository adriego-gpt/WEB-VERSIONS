...
- Completar el acceso a la prueba protegida, verificar la ejecución remota y activar el despliegue autorizado en `adriego.vercel.app`. El estado Ready acredita la compilación, no el funcionamiento de todas las rutas.
