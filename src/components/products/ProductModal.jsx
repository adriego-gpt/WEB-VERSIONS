...
export function ProductModal({
  ...
  return (
    <AnimatePresence>
      <Motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="modal-backdrop" onClick={closeProductDetail}>
        <Motion.div
        ...
        >
          ...
          <div className="modal-right" ref={modalRightRef}>
            <div className="product-modal-heading">
              ...
              <div className="product-modal-price-actions">
                <div className="product-modal-price-block">
                  <p className="product-modal-price">{currency(product.price)}</p>
            ...
            <div className="product-modal-variant-panel">
              <fieldset className="product-modal-option-group">
                <legend>Color <strong>{resolvedSelection?.color}</strong></legend>
              ...
              <fieldset className="product-modal-option-group product-modal-size-group">
                <legend>Talla <strong>{resolvedSelection?.size}</strong></legend>
            ...
            <div className="product-modal-benefits">
              <div><Truck size={18} /><p style={{ fontWeight: 600, marginBottom: 6 }}>Envios confiables</p><p className="muted" style={{ fontSize: 13 }}>Entrega coordinada por WhatsApp.</p></div>
              <div><RotateCcw size={18} /><p style={{ fontWeight: 600, marginBottom: 6 }}>Cambios fáciles</p><p className="muted" style={{ fontSize: 13 }}>Atención directa con nuestro equipo.</p></div>
              <div><ShieldCheck size={18} /><p style={{ fontWeight: 600, marginBottom: 6 }}>Compra segura</p><p className="muted" style={{ fontSize: 13 }}>Confirmacion personalizada.</p></div>
            </div>
